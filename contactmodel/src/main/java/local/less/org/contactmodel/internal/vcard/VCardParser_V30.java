...
//    /**
//     * @param strictParsing
//     *            when true, this object throws VCardException when the vcard is
...
//            if(DevEnv.bBackupDebug)Log.w(LOG_TAG, "Property name unsupported by vCard 3.0: "
//                    + propertyName);
//        }
//        return true;
//    }
...
//            if(DevEnv.bBackupDebug)Log.w(LOG_TAG, "AGENT in vCard 3.0 is not supported yet. Ignore it");
