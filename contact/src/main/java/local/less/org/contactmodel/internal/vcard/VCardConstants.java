...
public class VCardConstants {
    ...
    public static final String PROPERTY_X_GROUP = "X-GROUP";
    public static final String PROPERTY_X_STARRED = "X-STARRED"; // 收藏夹

    //导出通讯录的账号信息
    public static final String PROPERTY_X_ACCOUNT_TYPE = "X-ACCOUNT-TYPE";
    public static final String PROPERTY_X_ACCOUNT_NAME = "X-ACCOUNT-NAME";
    // 导出通讯录中的IM信息
    //    public static final String PROPERTY_X_IM = "X-IM";
    public static final String PROPERTY_X_SNS = "X-SNS";
    // 导出通讯录中的SIP信息
    public static final String PROPERTY_X_SIP = "X-SIP";
    // 导出通讯录中的Event信息
    public static final String PROPERTY_X_EVENT = "X-EVENT";
    // Symbian系统导出的昵称
    public static final String PROPERTY_X_EPOCSECONDNAME = "X-EPOCSECONDNAME";
    // Symbian系统导出的周年纪念日
    public static final String PROPERTY_X_ANNIVERSARY = "X-ANNIVERSARY";
    ...
    public static final String PROPERTY_X_RELATION = "X-RELATION";
    ...
    public static final String PARAM_TYPE_HOMEPAGE = "HOMEPAGE";
    public static final String PARAM_TYPE_BLOG = "BLOG";
    public static final String PARAM_TYPE_FTP = "FTP";
    public static final String PARAM_TYPE_PROFILE = "PROFILE";
    ...
    //
    // Note: Both vCard specs does not mention anything about the requirement
    // for this parameter,
    // but there may be some vCard importer which will get confused with more
    // than
    // one "PREF"s in one property name, while Android accepts them.
    public static final String PARAM_TYPE_PREF = "PREF";

    // Phone type parameters valid in vCard and known to ContactsContract, but
    // not so common.
    ...
    // TYPE parameters for Phones, which are not formally valid in vCard (at
    // least 2.1).
    // These types are basically encoded to "X-" parameters when composing
    // vCard.
    ...
    public static final String PARAM_EXTRA_TYPE_ANNIVERSARY = "ANNIVERSARY";
    public static final String PARAM_EXTRA_TYPE_BIRTHDAY = "BIRTHDAY";

    // DoCoMo specific type parameter. Used with "SOUND" property, which is
    // alternate of SORT-STRING in
    // vCard 3.0.
    ...
    public interface ImportOnly {
        ...
        // which is specifically invalid but should be always properly accepted,
        // and emitted
