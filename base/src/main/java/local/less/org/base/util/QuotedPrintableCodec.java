...
public class QuotedPrintableCodec {
     ...
     */
    public String decode(String pString, String charset) throws Exception {
        if (pString == null) {
            return null;
        }
    ...
    public Object encode(Object pObject) throws Exception {
        if (pObject == null) {
            ...
            throw new Exception("Objects of type " + pObject.getClass().getName() + " cannot be quoted-printable encoded");
        }
    }
    ...
    public Object decode(Object pObject) throws Exception {
        if (pObject == null) {
            ...
            throw new Exception("Objects of type " + pObject.getClass().getName() + " cannot be quoted-printable decoded");
        }
    }
     ...
     *
     */
    public String encode(String pString, String charset) throws Exception {
        if (pString == null) {
            return null;
        }
